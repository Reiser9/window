			    ...
			    <div className="container">
			        <div className="header__inner">
			            <Link to="/" className="logo">
			                <img src="/assets/img/logo.webp" className="logo__img" alt="Логотип" />
			            </Link>
			            ...
			            <img src="/assets/img/menu.webp" className="menu active" alt="Меню" />
			            <img src="/assets/img/close.webp" className="close" alt="Закрыть" />
			        </div>
			    </div>
			</header>
